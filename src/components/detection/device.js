export class Preflight {
    ...
    constructor(data, settings, mapstyles, burned) {
        ...
        this.settings.Firesize = null

        this.settings.Firemap = null

        this.settings.precache = true
    ...
    async process() {
        ...
        await this.googledoc.locations.forEach( (value) => {
        ...
        await this.googledoc.places.forEach( (value) => {

            value["lat"] = +value["lat"]

            value["lng"] = +value["lng"]

            value["reveal"] = +value["reveal"]

        });

        await this.googledoc.videos.forEach( (value) => {

            value["autoplay"] = (value["autoplay"]==='TRUE') ? true : false ;

            value["loop"] = (value["loop"]==='TRUE') ? true : false ;

            value["muted"] = (value["hasAudio"]==='TRUE') ? false : true ;

            value["controls"] = (value["controls"]==='TRUE') ? true : false ;

        });

        return { database : self.googledoc, settings : self.settings, mapstyles : self.mapstyles, burned : self.burned }
